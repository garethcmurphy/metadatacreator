  ...
  constructor() {
    this.metadataObject = {
      "0001": {
        ...
        comments:
          "A test-scan at the centers of 3*3 pixels. Attached figure shows the beam at P29.Total number of points to scan: 9Total time: ca 2 min----- Settings and configuration ---------------------------------------------------",
        "Time per pos": "10 s",
        "Step size": "6 mm",
        MAPMT: "ZA0250 @ 900 V",
      ...
      "0002": {
        ...
        category: "Measurement",
        comments:
          "An automated central scan of all pixels.The following parameters are used:X_pos = 23.65 mm to 65.65 mmY_pos = 34.65 mm to 76.65 mmStepsize = 6 mmCounting time = 20 sTotal number of points to scan: 64Total time: ca 22 min----- Settings and configuration ---------------------------------------------------",
      ...
      "0003": {
        ...
        comments:
          "A central measurement of P19 with 2.0\u00c5 neutrons.Counting time = 30 s----- Settings and configuration ---------------------------------------------------",
        MAPMT: "ZA0250 @ 900 V",
        "SoNDe module": "7053-1-008",
        "SoNDe acqu_ mode": "ACRO",
        "SoNDe threshold": "10",
      ...
      "0004": {
        ...
        comments:
          "To test the gamma sensitivity of the detector, the beam was turned off and an Cs-137 source was placed in the same position as the beam on the last collimator (see image).Attached is an image of the setup and 2D plot of the accumulated triggers for all 64 pixels. In the plot we can see that the highest gain pixels are have a higher rate, asexpected.Runtime: 17 minDistance source to scintillator: 9.5 cm----- Settings and configuration ---------------------------------------------------Attachment 2 shows a heatmap of the integrated 17 minutes triggers, as shown in daquri.",
        MAPMT: "ZA0250 @ 900 V",
        "SoNDe module": "7053-1-008",
        "SoNDe acqu_ mode": "ACRO",
        "SoNDe threshold": "10",
      ...
      "0005": {
        ...
        comments:
          "Scan with 1mm collimated neutron beam on a 14x14 mm2 pixel.Relative scan area.X: -1 to 13Y: 20 to 34----- Settings and configuration ---------------------------------------------------",
        MAPMT: "ZA0250 @ 900 V",
        "SoNDe module": "7053-1-008",
        "SoNDe acqu_ mode": "ACRO",
        "SoNDe threshold": "10",
      ...
      "0006": {
        ...
        comments:
          "The slits were opened up to maximum, HeBoSint and Mirrobor collimation was removed and another HeBoSint (with rectangular slits) was added directly onto the front of thedetector enclosure.Beam size: 68x68 mm2 (centered on detector)Counting time: 30 s----- Settings and configuration ---------------------------------------------------",
        MAPMT: "ZA0250 @ 900 V",
        "SoNDe module": "7053-1-008",
      ...
      "0007": {
        ...
        comments:
          "The slits were opened up to maximum, HeBoSint and Mirrobor collimation was removed. Plain scinitillator switched for pixelated scintillator.Counting time: 60 sBeam size: 68x68 mm2 (centered on detector)----- Settings and configuration ---------------------------------------------------",
        MAPMT: "ZA0250 @ 900 V",
        "SoNDe module": "7053-1-008",
        "SoNDe acqu_ mode": "TOF",
        "SoNDe threshold": "50",
      ...
      "0010": {
        ...
        comments:
          "The slits were opened up to maximum, HeBoSint and Mirrobor collimation was removed and another HeBoSint (with rectangular slits) was added directly onto the front of thedetector enclosure.Beam size: 68x68 mm2 (centered on detector)Counting time: 34 s----- Settings and configuration ---------------------------------------------------",
        MAPMT: "ZA0250 @ 900 V",
        "SoNDe module": "7053-1-008",
        "SoNDe acqu_ mode": "TOF",
        "SoNDe threshold": "50",
      ...
      "0016": {
        ...
        comments:
          "Similar as previous test (S6) but we changed the source to Co-60 instead.Runtime: 17 minDistance source to scintillator: 4 cm----- Settings and configuration ---------------------------------------------------",
        MAPMT: "ZA0250 @ 900 V",
        "SoNDe module": "7053-1-008",
        "SoNDe acqu_ mode": "ACRO",
        "SoNDe threshold": "10",
      ...
      "0017": {
        ...
        comments:
          "Neutron energy: 2.0\u00c5We changed the GS20 scintillator to the pixelated version. We scanned between the borders of two adjacent 6x6 mm2 scintillator pieces.Stepsize: 0.5 mmCounting time: 30 s----- Settings and configuration ---------------------------------------------------",
        MAPMT: "ZA0250 @ 900 V",
        "SoNDe module": "7053-1-008",
        "SoNDe acqu_ mode": "ACRO",
        "SoNDe threshold": "10",
